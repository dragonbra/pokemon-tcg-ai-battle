...
- 实际读取 trace 文件：170
- 对局：170；胜 / 负 / 平：107 / 61 / 2
- 我方错误：0
- 胜率：62.9%
- Meta 加权胜率：63.7%
- 第二回合 Powerful Hand：37/170 (21.8%)
- 我方被击倒事件：205
- 击倒后无 ready attacker：134/205 (65.4%)
...
| failure_class | 数量 |
|---|---:|
| bench_insurance_missed | 272 |
| post_ko_no_ready_attacker | 134 |
| second_turn_powerful_hand_missing | 133 |
...
```json
{
  ...
  "command": [
    ...
    "--label",
    "alakazam_v7_auto_iter_iter24_night_stretcher_successor",
    "--opponents",
    ...
    "--save-traces",
    "--output",
    "/private/tmp/alakazam-v7-auto-iter-24-full.hhAUso",
    "--cg-path",
  ...
  "games": 10,
  "label": "alakazam_v7_auto_iter_iter24_night_stretcher_successor",
  "opponents": [
    "romanrozen_v9",
    "pilkwang_v2",
    "kokinn_search",
