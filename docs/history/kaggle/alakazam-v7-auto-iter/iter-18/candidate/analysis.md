...
- 实际读取 trace 文件：170
- 对局：170；胜 / 负 / 平：109 / 60 / 1
- 我方错误：0
- 胜率：64.1%
- Meta 加权胜率：64.2%
- 第二回合 Powerful Hand：49/170 (28.8%)
- 我方被击倒事件：164
- 击倒后无 ready attacker：105/164 (64.0%)
- 出现过打手断档的对局：58/170 (34.1%)
...
```json
{
  ...
  "command": [
    ...
    "--label",
    "alakazam_v7_auto_iter_iter18_turn_count",
    "--opponents",
    ...
    "--save-traces",
    "--output",
    "/private/tmp/alakazam-v7-auto-iter-18-full.yHfT4B",
    "--cg-path",
  ...
  "games": 10,
  "label": "alakazam_v7_auto_iter_iter18_turn_count",
  "opponents": [
    "romanrozen_v9",
    "pilkwang_v2",
    "kokinn_search",
