...
- 实际读取 trace 文件：170
- 对局：170；胜 / 负 / 平：102 / 67 / 1
- 我方错误：0
- 胜率：60.0%
- Meta 加权胜率：58.9%
- 第二回合 Powerful Hand：38/170 (22.4%)
- 我方被击倒事件：172
- 击倒后无 ready attacker：123/172 (71.5%)
...
| failure_class | 数量 |
|---|---:|
| bench_insurance_missed | 279 |
| post_ko_no_ready_attacker | 123 |
| second_turn_powerful_hand_missing | 132 |
...
```json
{
  ...
  "command": [
    ...
    "--label",
    "alakazam_v7_auto_iter_iter22_poffin_enriching_gate",
    "--opponents",
    ...
    "--save-traces",
    "--output",
    "/private/tmp/alakazam-v7-auto-iter-22-full",
    "--cg-path",
  ...
  "games": 10,
  "label": "alakazam_v7_auto_iter_iter22_poffin_enriching_gate",
  "opponents": [
    "romanrozen_v9",
    "pilkwang_v2",
    "kokinn_search",
