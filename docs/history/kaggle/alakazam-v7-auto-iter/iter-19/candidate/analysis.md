...
- 胜率：62.4%
- Meta 加权胜率：60.7%
- 第二回合 Powerful Hand：48/170 (28.2%)
- 我方被击倒事件：183
- 击倒后无 ready attacker：115/183 (62.8%)
- 出现过打手断档的对局：66/170 (38.8%)
...
| failure_class | 数量 |
|---|---:|
| bench_insurance_missed | 310 |
| post_ko_no_ready_attacker | 115 |
| second_turn_powerful_hand_missing | 122 |
...
```json
{
  ...
  "command": [
    ...
    "--label",
    "alakazam_v7_auto_iter_iter19_bench_alakazam",
    "--opponents",
    ...
    "--save-traces",
    "--output",
    "/private/tmp/alakazam-v7-auto-iter-19-full.XekKhU",
    "--cg-path",
  ...
  "games": 10,
  "label": "alakazam_v7_auto_iter_iter19_bench_alakazam",
  "opponents": [
    "romanrozen_v9",
    "pilkwang_v2",
    "kokinn_search",
