...
- [`rl/behavior-cloning-history-conclusions-20260722.md`](rl/behavior-cloning-history-conclusions-20260722.md)：清理旧 runs 后保留的规则 teacher BC、reward、MCTS 与 DAgger 结论。
- [`rl/yushin-ito-exact-bc-baseline-20260722.md`](rl/yushin-ito-exact-bc-baseline-20260722.md)：Yushin Ito exact submission 的纯模型 BC baseline、固定评测和 Alakazam BC v1 归档。
