...
- 0045 V13 inventory：`docs/model/DESIGN.md:71-94`；`src/pokemon_tcg_ai/policy/shared_encoder_lora.py:57-110`。
- 0045 checkpoint omission/recovery：`docs/model/decisions.md:41-47`；`docs/model/DESIGN.md:196-216`。原始路径与当时的 worktree 状态可通过封存 tag 复核。
...
- deck 007 identity/provenance：`src/pokemon_tcg_ai/assets/decks/registry.json:716-735`；human-readable list 在 `src/pokemon_tcg_ai/assets/decks/text/007.txt:1-88`。
- deck 067 identity/provenance：同 registry `:7420-7445`；append source `src/pokemon_tcg_ai/append_user_dragapult_decks.py:20-45`；list 在 `src/pokemon_tcg_ai/assets/decks/text/067.txt:1-90`。
- Training identity：
...
- Exporter 当前 hard gate 与 write path：`src/pokemon_tcg_ai/evaluation/export_kaggle.py:110-119,187-217`；原始开发状态可通过封存 tag 复核。
