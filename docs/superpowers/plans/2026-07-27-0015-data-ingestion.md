...
- [x] **Step 1: Query dataset metadata**
...
- [x] **Step 2: Download to an isolated staging path**
...
- [x] **Step 3: Validate and publish the archive**
...
- [x] **Step 1: List completed public episodes per Dragapult submission**
...
- [x] **Step 2: Reuse official 0726 coverage and fetch gaps**
...
- [x] **Step 4: Publish the overlay audit**
...
- [x] **Step 1: Cross-check hashes and counts**
