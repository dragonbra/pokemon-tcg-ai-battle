...
当时使用的 `submission/official_water/` 已随过时 submission 清理而删除。以下路径和命令仅用于说明 2026-07-18 的历史运行方式，不再是可执行入口：

- 入口：`submission/official_water/main.py`
- 卡组：`submission/official_water/deck.csv`
- 模拟器 API：`submission/official_water/cg/`
