...
RUN_PATH = "dragon_bra/pokemon-tcg-policy-learning/0044-v2-mixed-focal-cohorts"
VERSION_ROOT = ROOT / "rl_runs/0044_g2_dragapult_policy_option_lora/versions/V2_mixed_focal_cohorts"
...
def run(*, output_root: Path, scheduled_epoch: float) -> dict[str, Any]:
    ...
    with lock_path.open("a+") as lock:
        ...
        name = f"0044_dragapult_ex_007_v2_u{update:03d}_fp16_storage_fp32_runtime"
        ...
        message = f"0044 V2 U{update} · 007 Dragapult · rollout-selected"
        attempt = {
        ...
        while time.monotonic() < deadline:
            ...
            time.sleep(30)
        receipt = {
            "schema_version": "0044_deck007_single_kaggle_submission_receipt_v1",
