"""Export an R13 checkpoint as a self-contained arena candidate."""
...
from strategy.r13_inference import R13Policy
...
_POLICY = R13Policy.from_checkpoint(
...
def export_candidate(
    ...
    if metadata.get("schema_version") != "0014_r13_training_v1":
        raise ValueError("checkpoint is not a 0014 R13 policy")
    ...
    copies = {
        ...
        "r12_model.py": "r12_model.py",
        "r13_model.py": "r13_model.py",
        "r13_inference.py": "r13_inference.py",
    ...
    manifest = {
        "schema_version": "0014_r13_candidate_v1",
