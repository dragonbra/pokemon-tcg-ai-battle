"""Export an R16 checkpoint as a self-contained arena candidate."""
...
from strategy.r16_inference import R16Policy
...
_POLICY = R16Policy.from_checkpoint(
...
def export_candidate(
    ...
    if metadata.get("schema_version") != "0014_r16_training_v1":
        raise ValueError("checkpoint is not a 0014 R16 policy")
    ...
    copies = {
        ...
        "r16_model.py": "r16_model.py",
        "r16_inference.py": "r16_inference.py",
    ...
    manifest = {
        "schema_version": "0014_r16_candidate_v1",
