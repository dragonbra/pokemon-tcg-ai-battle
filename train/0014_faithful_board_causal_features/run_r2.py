"""Preflight, allocate and train the 0014 R2 strong-scenario policy."""
...
from .r2_model import R2ModelConfig, R2StrongScenarioPolicy, parameter_count
...
def main() -> None:
    ...
    parser.add_argument("--version", default="V11_r2_strong_scenario_scalegate")
    ...
    if not torch.cuda.is_available():
        raise RuntimeError("0014 R2 requires CUDA")
        ...
        os.environ.update(
            {
                ...
                "WANDB_JOB_TYPE": "bc",
                "WANDB_TAGS": "0014,r2,all_features,strong_scenario,scalegate",
            }
        )
        epochs, max_train, max_validation = arguments.epochs, None, None

    config = {
        "schema_version": "0014_r2_training_v1",
