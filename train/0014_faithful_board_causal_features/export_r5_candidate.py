"""Export an R5 checkpoint as a self-contained arena candidate."""
...
from strategy.r5_inference import R5Policy
...
_POLICY = R5Policy.from_checkpoint(
...
def export_candidate(
    ...
    if metadata.get("schema_version") != "0014_r5_training_v1":
        raise ValueError("checkpoint is not a 0014 R5 policy")
    ...
    copies = {
        ...
        "r5_inference.py": "r5_inference.py",
    ...
    manifest = {
        "schema_version": "0014_r5_candidate_v1",
