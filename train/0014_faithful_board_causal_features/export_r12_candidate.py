"""Export an R12 checkpoint as a self-contained arena candidate."""
...
from strategy.r12_inference import R12Policy
...
_POLICY = R12Policy.from_checkpoint(
...
def export_candidate(
    ...
    if metadata.get("schema_version") != "0014_r12_training_v1":
        raise ValueError("checkpoint is not a 0014 R12 policy")
    ...
    copies = {
        ...
        "r12_inference.py": "r12_inference.py",
    ...
    manifest = {
        "schema_version": "0014_r12_candidate_v1",
