"""Export a V10 R1 checkpoint as a self-contained arena candidate."""
...
def export_candidate(
    ...
    if metadata.get("schema_version") != "0014_r1_training_v1":
        raise ValueError("checkpoint is not a 0014 R1 policy")
    ...
    copies = {
        ...
        "r1_model.py": "r1_model.py",
        "r1_inference.py": "r1_inference.py",
    ...
    manifest = {
        "schema_version": "0014_r1_candidate_v1",
