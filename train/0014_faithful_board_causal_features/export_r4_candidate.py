"""Export an R4 checkpoint as a self-contained arena candidate."""
...
def export_candidate(
    ...
    if metadata.get("schema_version") != "0014_r4_training_v1":
        raise ValueError("checkpoint is not a 0014 R4 policy")
    ...
    copies = {
        ...
        "r4_model.py": "r4_model.py",
        "r4_inference.py": "r4_inference.py",
    ...
    manifest = {
        "schema_version": "0014_r4_candidate_v1",
