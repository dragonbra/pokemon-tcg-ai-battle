"""Export an R14 checkpoint as a self-contained arena candidate."""
...
from strategy.r14_inference import R14Policy
...
_POLICY = R14Policy.from_checkpoint(
...
def export_candidate(
    ...
    if metadata.get("schema_version") != "0014_r14_training_v1":
        raise ValueError("checkpoint is not a 0014 R14 policy")
    ...
    copies = {
        ...
        "r14_model.py": "r14_model.py",
        "r14_inference.py": "r14_inference.py",
    ...
    manifest = {
        "schema_version": "0014_r14_candidate_v1",
