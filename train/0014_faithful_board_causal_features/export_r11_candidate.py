"""Export an R11 checkpoint as a self-contained arena candidate."""
...
from strategy.r11_inference import R11Policy
...
_POLICY = R11Policy.from_checkpoint(
...
def export_candidate(
    ...
    if metadata.get("schema_version") != "0014_r11_training_v1":
        raise ValueError("checkpoint is not a 0014 R11 policy")
    ...
    copies = {
        ...
        "r11_model.py": "r11_model.py",
        "r11_inference.py": "r11_inference.py",
    ...
    manifest = {
        "schema_version": "0014_r11_candidate_v1",
