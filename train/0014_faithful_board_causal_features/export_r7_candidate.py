"""Export an R7 checkpoint as a self-contained arena candidate."""
...
from strategy.r7_inference import R7Policy
...
_POLICY = R7Policy.from_checkpoint(
...
def export_candidate(
    ...
    if metadata.get("schema_version") != "0014_r7_training_v1":
        raise ValueError("checkpoint is not a 0014 R7 policy")
    ...
    copies = {
        ...
        "r7_inference.py": "r7_inference.py",
    ...
    manifest = {
        "schema_version": "0014_r7_candidate_v1",
