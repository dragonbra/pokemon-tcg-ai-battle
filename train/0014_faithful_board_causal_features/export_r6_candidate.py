"""Export an R6 checkpoint as a self-contained arena candidate."""
...
from strategy.r6_inference import R6Policy
...
_POLICY = R6Policy.from_checkpoint(
...
def export_candidate(
    ...
    if metadata.get("schema_version") != "0014_r6_training_v1":
        raise ValueError("checkpoint is not a 0014 R6 policy")
    ...
    copies = {
        ...
        "r6_model.py": "r6_model.py",
        "r6_inference.py": "r6_inference.py",
    ...
    manifest = {
        "schema_version": "0014_r6_candidate_v1",
