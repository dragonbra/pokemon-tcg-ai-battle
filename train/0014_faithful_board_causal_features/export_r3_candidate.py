"""Export an R3 checkpoint as a self-contained arena candidate."""
...
def export_candidate(
    ...
    if metadata.get("schema_version") != "0014_r3_training_v1":
        raise ValueError("checkpoint is not a 0014 R3 policy")
    ...
    copies = {
        ...
        "r3_model.py": "r3_model.py",
        "r3_inference.py": "r3_inference.py",
    ...
    manifest = {
        "schema_version": "0014_r3_candidate_v1",
