...
from strategy.r15_inference import R15Policy
...
_POLICY = R15Policy.from_checkpoint(
...
def export_candidate(
    ...
    if metadata.get("schema_version") != "0014_r15_training_v1":
        raise ValueError("checkpoint is not a 0014 R15 policy")
    ...
    copies = {
        ...
        "r15_inference.py": "r15_inference.py",
    ...
    manifest = {
        "schema_version": "0014_r15_candidate_v1",
