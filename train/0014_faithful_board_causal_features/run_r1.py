"""Preflight, allocate and train the 0014 R1 structured causal policy."""
...
from .r1_model import R1ModelConfig, R1StructuredCausalPolicy, parameter_count
...
def main() -> None:
    ...
    parser.add_argument("--version", default="V10_r1_structured_causal_policy")
    ...
    parser.add_argument("--smoke-tag", default="V0_r1_noncanonical_smoke")
    arguments = parser.parse_args()
    if not torch.cuda.is_available():
        raise RuntimeError("0014 R1 requires CUDA")
        ...
        os.environ.update(
            {
                ...
                "WANDB_JOB_TYPE": "bc",
                "WANDB_TAGS": "0014,r1,all_features,structured_causal",
            }
        )
        epochs, max_train, max_validation = arguments.epochs, None, None

    config = {
        "schema_version": "0014_r1_training_v1",
        ...
        json.dumps(
            {
                ...
                "inherited_zero_initialized_ac_gates": [
                ...
                "r1_conditioning": {
                    "scenario_memory": [
                        "public_zone_tokens",
                        "registered_deck_ledger_tokens",
                        "event_summary",
                        "known_unknown_opponent_hand",
                        "four_goal_tokens",
                    ],
                    "state_and_option_cross_attention": True,
                    "option_goal_routing": True,
                    "initial_conditioning_strength": (
                        model_config.initial_conditioning_strength
                    ),
                },
                "input_keys": [
