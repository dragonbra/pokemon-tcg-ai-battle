"""Export an R8 checkpoint as a self-contained arena candidate."""
...
from strategy.r8_inference import R8Policy
...
_POLICY = R8Policy.from_checkpoint(
...
def export_candidate(
    ...
    if metadata.get("schema_version") != "0014_r8_training_v1":
        raise ValueError("checkpoint is not a 0014 R8 policy")
    ...
    copies = {
        ...
        "r8_model.py": "r8_model.py",
        "r8_inference.py": "r8_inference.py",
    ...
    manifest = {
        "schema_version": "0014_r8_candidate_v1",
