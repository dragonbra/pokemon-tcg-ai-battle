"""Export an R10 checkpoint as a self-contained arena candidate."""
...
from strategy.r10_inference import R10Policy
...
_POLICY = R10Policy.from_checkpoint(
...
def export_candidate(
    ...
    if metadata.get("schema_version") != "0014_r10_training_v1":
        raise ValueError("checkpoint is not a 0014 R10 policy")
    ...
    copies = {
        ...
        "r10_model.py": "r10_model.py",
        "r10_inference.py": "r10_inference.py",
    ...
    manifest = {
        "schema_version": "0014_r10_candidate_v1",
