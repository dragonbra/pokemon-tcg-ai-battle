"""Compile faithful 0010 tensors and every audited 0014 auxiliary family."""
...
_m0010 = importlib.import_module("train.project_0010_alakazam_sota_model.model")
_semantics = importlib.import_module("train.0013_semantic_goal_policy.features.compiler")

COMPILER_VERSION = "faithful_board_causal_compiler_v1"
A0_MAX_ACTION_STEPS = 16
FULL_CACHE_MAX_ACTION_STEPS = 21
SEMANTIC_WIDTH = 64
ZONE_NUM_WIDTH = 16
LEDGER_NUM_WIDTH = 15
LEDGER_CAT_WIDTH = 4
