...
def build_selection_audit(
    *,
    ...
    return {
        "schema": "0034_focal_selection_audit_v1",
        "selection_rule": "user_business_value_override_after_epoch2_evidence_audit",
        "selected_deck_id": selected_deck_id,
        "selected": selected,
        "offline_metric_leader": ranked[0],
        "business_rationale": (
            "The user selected the exact current Third PTCG Club Dragapult list after its "
            "Large Model 0806 Epoch 13 Frozen 0019 zero-shot baseline."
        ),
