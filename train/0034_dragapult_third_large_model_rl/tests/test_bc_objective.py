...
bc = importlib.import_module("train.0034_dragapult_third_large_model_rl.training.bc_smoke")
model_module = importlib.import_module("train.0034_dragapult_third_large_model_rl.model")
fixtures = importlib.import_module("train.0034_dragapult_third_large_model_rl.tests.test_contract")
