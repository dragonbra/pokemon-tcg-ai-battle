...
_r2 = importlib.import_module("train.0014_faithful_board_causal_features.r2_model")
R2ModelConfig = _r2.R2ModelConfig
R2StrongScenarioPolicy = _r2.R2StrongScenarioPolicy


@dataclass(frozen=True)
class SourceConditionedR2Config:
    r2: object = field(default_factory=R2ModelConfig)
...
class SourceConditionedR2Policy(R2StrongScenarioPolicy):
    """Keep the 0014 V12 R2 trunk intact and add the audited source residual."""
