...
VERSION = "V9_benchmark_v1_champion_g2_002_003_007_009"
...
def validate_report(report: dict[str, Any]) -> None:
    ...
    if (
        ...
        or report.get("focal_policy_id") != "Champion-G2"
        ...
        raise RuntimeError("Benchmark V1 is not 2,048 valid terminal G2 focal games")
    if (
...
def run(*, deck_id: str, output_root: Path) -> dict[str, Any]:
    ...
    jobs = [RolloutJob(
        ...
        policy_seed=row["policy_seed"], source_policy_update=407,
    ...
    report = {
        "schema_version": "0043_benchmark_v1_report_v1",
        "created_at": datetime.now(UTC).isoformat(), "status": "PASS",
        "benchmark_id": "Benchmark-V1", "version": VERSION,
        "focal_policy_id": "Champion-G2", "focal_policy_role": "promoted_immutable",
        "focal_checkpoint_update": 407,
...
def main() -> int:
    ...
    report = run(deck_id=args.deck_id, output_root=output.resolve())
