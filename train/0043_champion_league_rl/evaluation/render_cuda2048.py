...
"""
    return f'''<!doctype html><html lang="zh-CN"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>0043 U20 · Deck {report['focal_deck_id']} · CUDA-2048</title><style>{style}</style></head><body><main>
<header><p>0043 CHAMPION LEAGUE RL · FROZEN POLICY-0809</p><h1>U20 · Deck {report['focal_deck_id']} · CUDA-2048</h1><p>{html.escape(report['focal_deck_display_name'])} · CUDA Engine 2.0 · greedy · official engine · 独立强度证据</p></header>
