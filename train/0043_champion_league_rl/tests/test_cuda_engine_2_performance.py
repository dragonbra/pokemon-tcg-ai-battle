...
module = importlib.import_module("train.0043_champion_league_rl.cuda_engine_2.performance")
...
def test_0043_resident_backend_is_identity_gated_and_device_only() -> None:
    resident = importlib.import_module("train.0043_champion_league_rl.cuda_engine_2.resident")
