...
arena_module = importlib.import_module("train.0043_champion_league_rl.cuda_engine_2.arena")
inference = importlib.import_module("train.0043_champion_league_rl.cuda_engine_2.inference")
ROOT = Path(__file__).resolve().parents[3]
PROJECT = ROOT / "train/0043_champion_league_rl"
