...
module = importlib.import_module("train.0043_champion_league_rl.promote.workflow")
...
def test_candidate_freeze_and_explicit_decision_binding(tmp_path) -> None:
    ...
    record = module.freeze_candidate_record(
        candidate_id="Candidate-0043-update000100", source_checkpoint=checkpoint,
...
def test_automation_or_mismatched_evidence_cannot_promote() -> None:
    record = {"candidate_id": "Candidate-0043-x", "candidate_record_sha256": "a" * 64}
    decision = {
