...
module = importlib.import_module("train.0043_champion_league_rl.training.config")
ROOT = Path(__file__).resolve().parents[3]
CONFIG = ROOT / "experiments/0043_champion_league_rl/active_training_config.json"
