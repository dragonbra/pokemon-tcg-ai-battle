...
def freeze_candidate_record(
    *, candidate_id: str, source_checkpoint: Path, source_update: int,
    ...
    if not candidate_id.startswith("Candidate-0043-"):
        raise PromotionGateError("candidate_id must use the Candidate-0043 namespace")
    ...
    record = {
        "schema_version": "0043_frozen_candidate_record_v1",
