...
CANDIDATE_ID = "Candidate-0043-U407"
...
def collect_full67_evidence(repository_root: Path) -> dict[str, Any]:
    project_root = repository_root / "train/0043_champion_league_rl"
...
def promote_champion_g2(
    ...
    promotion_path = (
        repository_root / "experiments/0043_champion_league_rl/promotion/"
    ...
    manifest = {
        ...
        "frozen": True,
        "parent_policy_id": "Champion-G1",
        "architecture_version": "0043_focal_v1_model_only_v1",
        "source_checkpoint_schema": "0043_focal_v1_model_only_v1",
        "source_checkpoint_artifact_purpose": "model_only_checkpoint",
        "portable_checkpoint_schema": "0043_focal_v1_kaggle_candidate_v1",
        ...
        "promotion_record": "experiments/0043_champion_league_rl/promotion/champion_g002_u407.json",
        "source": {
    ...
    promotion = {
        "schema_version": "0043_champion_promotion_record_v1",
        "status": "PROMOTED",
        "policy_id": POLICY_ID,
        "generation": 2,
        "parent_policy_id": "Champion-G1",
