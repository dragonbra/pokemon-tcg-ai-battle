...
VERSION_ROOT = PROJECT_ROOT.parents[1] / "rl_runs/0044_g2_dragapult_policy_option_lora/versions/V1_focal_002_007"
...
def migrate() -> dict[str, Any]:
    ...
    fp32_metadata.update({
        ...
        "model_schema": "0044_strategy_conditioned_own_taxonomy_v2",
    ...
    fp32_out = {
        **fp32, "schema_version": "0044_focal_v1_model_only_v1", "update": 0,
    ...
    portable_metadata.update({
        "project_id": "0044_g2_dragapult_policy_option_lora", "version": "V1-Focal-Seed",
    ...
    portable_out["schema_version"] = "0044_focal_v1_kaggle_candidate_v1"
    ...
    migration = {
        "schema_version": "0044_own_archetype_embedding_migration_v1",
    ...
    manifest = {
        "schema_version": "0044_focal_seed_manifest_v1",
        ...
        "architecture_version": "0044_strategy_conditioned_own_taxonomy_v2",
        ...
        "optimizer": {"state_migrated": False, "initialization": "fresh_from_approved_0044_groups"},
