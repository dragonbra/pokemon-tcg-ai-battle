"""0045 V7: recover durable V6 U276 after telemetry-only failure."""
...
PARENT_VERSION = "V6_dragapult_007_u275_aggressive_meta_quota_policy0809"
PARENT_CHECKPOINT = (
    ROOT / "rl_runs/0045_single_deck_expert_minimal_lora/versions"
    / PARENT_VERSION / "checkpoint/update-000276.pt"
)
PARENT_CHECKPOINT_SHA256 = "a75e183643842be6620fd57b60e5f96750f36847f69701b3959ce1e05aed05df"
...
def readiness(*, version_root: Path = VERSION_ROOT) -> dict[str, object]:
    ...
    if (
        ...
        raise RuntimeError("V7 parent is not durable V6 U276")
    ...
    return {
        "schema_version": "0045_v7_u276_aggressive_meta_quota_readiness_v1",
        "status": "READY_AWAITING_USER_LAUNCH",
        "version": VERSION,
        "recovery": {
            "failed_version": PARENT_VERSION,
            "failure_stage": "after_durable_u276_before_metrics_and_eval",
...
def launch(*, wandb_mode: str = "online", updates: int | None = None) -> None:
    ...
    run(
        ...
        wandb_name="0045 · V7 · U276 aggressive recovery · Policy-0809",
