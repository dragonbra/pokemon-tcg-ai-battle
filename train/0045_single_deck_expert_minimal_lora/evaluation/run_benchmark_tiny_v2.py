"""Run formal 0045 Benchmark Tiny V2 CUDA-512 with common random numbers."""
...
def validate_report(report: dict[str, Any]) -> None:
    ...
    if (
        ...
        or report.get("benchmark_id") != "Benchmark-Tiny-V2"
        ...
        raise RuntimeError("Benchmark Tiny V2 is not 512 valid deployment-audited games")
    if (
        ...
        or schedule.get("opponent_policy_id") != "Champion-G2"
...
def run(
    *, deck_id: str, output_root: Path, checkpoint: Path | None,
    ...
    opponent_bundle = materialize_policy_bundle(
        PROJECT_ROOT, opponent_policy_id, purpose="0045_benchmark_tiny_v2_opponent"
    )
    ...
    report = {
        "schema_version": "0045_benchmark_tiny_v2_report_v1",
        "created_at": datetime.now(UTC).isoformat(), "status": "PASS",
        "benchmark_id": "Benchmark-Tiny-V2", "focal_policy_id": "0045-candidate",
