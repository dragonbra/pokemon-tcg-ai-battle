...
CONTRACT_PATH = REPOSITORY_ROOT / "experiments/0044_g2_dragapult_policy_option_lora/initial_run_contract.json"
...
def acceptance(seed: int = 430044001, *, schedules: int = 64) -> dict[str, Any]:
    ...
    return {
        "schema_version": "0044_initial_run_acceptance_v1",
        "status": "PASS",
