...
class CudaEngineIdentity:
    ...
    status: str = "PASS"
    schema_version: str = "0044_cuda_engine_2_identity_v1"
    ...
    def resolve(
        ...
        if config.get("schema_version") != "0044_cuda_engine_2_config_v1":
            raise CudaEngineIdentityError("unsupported 0044 CUDA Engine 2.0 config")
