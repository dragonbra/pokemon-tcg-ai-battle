...
MODULE = "train.0045_single_deck_expert_minimal_lora.evaluation.public_deck_router_v2_rules"
...
def test_shared_actor_audit_excludes_only_action_decoder_tensors():
    runtime = importlib.import_module(
        "train.0045_single_deck_expert_minimal_lora.evaluation.public_deck_router_v2"
    )
    states = {
        update: {
