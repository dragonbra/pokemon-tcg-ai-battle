...
MODULE = "train.0045_single_deck_expert_minimal_lora.evaluation.public_deck_router_v3_rules"
...
def test_v3_actor_audit_routes_v19_state_ffn_and_option_norm_differences():
    runtime = importlib.import_module(
        "train.0045_single_deck_expert_minimal_lora.evaluation.public_deck_router_v3"
    )
    states = {
        update: {
...
def test_v3_deployment_memory_matches_evaluation_rules():
    ...
    deployment = importlib.import_module(
        "train.0045_single_deck_expert_minimal_lora.semantic_runtime.deployment."
