...
def main() -> None:
    ...
    parser.add_argument("--version", default="V1_universal_winner_r15")
    ...
    if not torch.cuda.is_available():
        raise RuntimeError("0019 source-conditioned R15 requires CUDA")
    ...
    if arguments.smoke:
        ...
        root = Path(".tmp/0019_universal_winner_bc") / version
        if root.exists():
        ...
        os.environ.update(
            {
                ...
                "WANDB_JOB_TYPE": "bc",
                "WANDB_TAGS": "0019,r15,universal_winner,source_conditioned,gradual_option",
            }
        )
    ...
    config = {
        "schema_version": "0019_universal_winner_training_v1",
    ...
    result = train(
        ...
        initial_best=None,
        initial_no_loss_improvement=0,
        initial_progress_iteration=0,
        initial_history=(),
        early_stopping_patience=arguments.early_stopping_patience,
        early_stopping_min_delta=arguments.early_stopping_min_delta,
    )
