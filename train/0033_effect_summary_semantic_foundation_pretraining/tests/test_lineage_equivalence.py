...
DOMAIN = importlib.import_module(
    "train.0033_effect_summary_semantic_foundation_pretraining.domain"
)
MODEL = importlib.import_module(
    "train.0033_effect_summary_semantic_foundation_pretraining.model"
)
...
class LineageEquivalenceTests(unittest.TestCase):
    ...
    def test_default_policy_has_effect_summary_0033_capacity(self) -> None:
