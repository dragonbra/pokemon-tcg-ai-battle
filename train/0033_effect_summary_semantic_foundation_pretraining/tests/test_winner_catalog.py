...
CONTRACT = importlib.import_module(
    "train.0033_effect_summary_semantic_foundation_pretraining.data.replay_contract"
)
CATALOG = importlib.import_module(
    "train.0033_effect_summary_semantic_foundation_pretraining.data.winner_catalog"
)
