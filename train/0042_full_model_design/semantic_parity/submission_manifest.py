"""Generate the immutable, fail-closed 0042 submission release manifest."""
...
def build_manifest(
    *, inventory: Mapping[str, Any], gates: Mapping[str, Mapping[str, Any]]
    ...
    result = {
        "schema_version": "0042_submission_release_manifest_v1",
        ...
        "checkpoint": {
            ...
            "value_adapter_sha256": checkpoint["component_sha256"]["value_adapter"],
            "policy_strategy_adapter_sha256": checkpoint[
                "component_sha256"
        ...
        "package": {
            ...
            "value_runtime_role": (
                "q0/q1, frozen Meta logits, and adapted Value condition policy readout"
            ),
