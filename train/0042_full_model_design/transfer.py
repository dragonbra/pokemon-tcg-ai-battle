"""Audited, explicit Policy-0809 initialization transfer."""
...
SOURCE_CHECKPOINT_SHA256 = "926321955b6f3144b62e65899b5041ca3a47b17f305202ba9dffc0c92aaa7c7f"
SOURCE_SCHEMA = "0031_model_only_checkpoint_v1"
SOURCE_PROJECT = "0031_rule_faithful_semantic_foundation_pretraining"
SOURCE_VERSION = "V5_medal_zone_gsb_all_days"
SOURCE_ARM = "rule_faithful_semantic"
SOURCE_EPOCH = 20
SOURCE_GLOBAL_STEP = 115820
...
def transfer_state_dict(
    ...
    *,
    ...
    return {
        "schema": "0034_weight_transfer_audit_v1",
...
def load_0031_initialization(
    ...
    *,
    ...
    if not isinstance(metadata, Mapping) or any(
        ...
        raise ValueError("0031 checkpoint metadata does not match Policy-0809 V5 epoch 20")
