...
gate_module = importlib.import_module("train.0042_full_model_design.action_boundary.decision_gate")
dragapult_module = importlib.import_module("train.0042_full_model_design.action_boundary.dragapult")
macro_module = importlib.import_module("train.0042_full_model_design.action_boundary.macro_protocol")
head_module = importlib.import_module("train.0042_full_model_design.policy.allocation_head")
protocol_module = importlib.import_module("train.0042_full_model_design.rollout.protocol")
gae_module = importlib.import_module("train.0042_full_model_design.training.compound_gae")
ppo_module = importlib.import_module("train.0042_full_model_design.training.compound_ppo")
checkpoint_module = importlib.import_module("train.0042_full_model_design.checkpoint")
...
class CheckpointContractTests(unittest.TestCase):
    ...
    def test_current_and_complete_legacy_action_contracts_are_accepted_but_mixed_is_not(self):
