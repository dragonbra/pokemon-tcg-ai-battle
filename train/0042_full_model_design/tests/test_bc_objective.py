...
bc = importlib.import_module("train.0042_full_model_design.training.bc_smoke")
model_module = importlib.import_module("train.0042_full_model_design.model")
fixtures = importlib.import_module("train.0042_full_model_design.tests.test_contract")
