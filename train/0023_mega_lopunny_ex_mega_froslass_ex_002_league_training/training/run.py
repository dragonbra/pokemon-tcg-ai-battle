"""Guarded focal-only PPO orchestration retained for 0023 diagnostics."""
...
def compose_training_config(initialization: dict[str, object], config: LeagueTrainingConfig, *,
    ...
    return {
        **initialization, "schema_version": "0023_focal_league_ppo_v1",
...
def run_training(config: LeagueTrainingConfig, *, deck_root: Path = DEFAULT_DECK_ROOT) -> int:
    ...
    os.environ.update({
        ...
        "WANDB_TAGS": "0023,league,ppo,mega_lopunny,mega_froslass,focal_only",
    })
