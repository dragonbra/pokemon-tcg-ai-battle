"""Validated, named tensor batch passed to the 0031 policy."""
...
_MASK_RELATIONS = {
    ...
    "option_skill_mask": "option_skill_id",
    "option_effect_mask": "option_effect_id",
}
_SEQUENCE_RELATIONS = {
    "card_parent": "card_cat",
    "event_source": "event_cat",
    "event_target": "event_cat",
    "event_before": "event_cat",
    "event_after": "event_cat",
    "option_source": "option_cat",
    "option_target": "option_cat",
    "option_context": "option_cat",
    "option_effect_card": "option_cat",
    "option_skill_role": "option_skill_id",
    "option_skill_parent": "option_skill_id",
    "option_effect_role": "option_effect_id",
    "option_effect_parent": "option_effect_id",
}
