"""Export a self-contained 0035 runtime from a compatible 0031 checkpoint."""
...
def export_candidate(
    *,
    ...
    if (
        ...
        or metadata.get("project_id") not in SOURCE_MODEL_PROJECT_IDS
    ...
    try:
        ...
        manifest = {
            ...
            "compiler_implementation_version": "0035_lifetime_aware_feature_compiler_v1",
            "source_checkpoint_project_id": metadata.get("project_id"),
