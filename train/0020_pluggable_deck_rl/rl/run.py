...
def _configure_wandb(args: argparse.Namespace) -> None:
    ...
    os.environ.setdefault("WANDB_TAGS", "0020,dragapult,terminal_reward,official_engine")
...
def _base_config(
    ...
    *,
    ...
    return {
        "schema_version": "0020_terminal_rl_training_v1",
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="0020 Dragapult terminal-reward RL")
