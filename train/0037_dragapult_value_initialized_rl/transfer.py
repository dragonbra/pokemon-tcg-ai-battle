"""Audited, explicit 0031-to-0034 initialization transfer."""
...
def load_0031_initialization(
    ...
    *,
    ...
    if not isinstance(metadata, Mapping) or any(
        ...
        raise ValueError("0031 checkpoint metadata does not match Large Model 0806 Epoch 11")
