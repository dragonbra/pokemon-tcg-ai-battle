"""Formal resident-CUDA PPO runner for 0034."""
...
def _opponent_snapshot(runtime: RuntimeBundle, args: argparse.Namespace) -> dict[str, Any]:
    ...
    return {
        "schema": "0034_frozen_opponent_snapshot_v1",
...
def run(args: argparse.Namespace) -> int:
    ...
    os.environ.update(
        {
            ...
            "WANDB_JOB_TYPE": "ppo",
            "WANDB_RUN_ID": f"0034-{args.version.lower().replace('_', '-')}",
            "WANDB_NAME": f"0034 · dragapult_third_large_model_rl · {args.version}",
            "WANDB_RUN_GROUP": PROJECT,
            "WANDB_TAGS": "0034,cuda,ppo,dragapult_third_ptcg_club,third_ptcg_club",
    ...
    config = {
        "schema": "0034_cuda_ppo_training_config_v1",
        "version": args.version,
        "focal_deck_id": FOCAL_DECK_ID,
        "source_checkpoint": str(args.source_checkpoint),
        "source_checkpoint_sha256": _sha256(args.source_checkpoint),
        "source_checkpoint_role": "large_model_0806_epoch13_initialization_only",
