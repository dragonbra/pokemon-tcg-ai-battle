...
bc = importlib.import_module("train.0037_dragapult_value_initialized_rl.training.bc_smoke")
model_module = importlib.import_module("train.0037_dragapult_value_initialized_rl.model")
fixtures = importlib.import_module("train.0037_dragapult_value_initialized_rl.tests.test_contract")
