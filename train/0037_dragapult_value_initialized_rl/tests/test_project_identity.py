...
actor_critic = importlib.import_module(
    "train.0037_dragapult_value_initialized_rl.policy.actor_critic"
)
runtime = importlib.import_module(
    "train.0037_dragapult_value_initialized_rl.training.runtime"
)
transfer = importlib.import_module("train.0037_dragapult_value_initialized_rl.transfer")
exporter = importlib.import_module(
    "train.0037_dragapult_value_initialized_rl.export_zero_shot_candidate"
)
full_runner = importlib.import_module(
    "train.0037_dragapult_value_initialized_rl.training.run_full_semantic"
)
league = importlib.import_module("train.0037_dragapult_value_initialized_rl.league")
...
class ProjectIdentityTest(unittest.TestCase):
    ...
    def test_no_executable_cross_project_imports(self) -> None:
        project = Path("train/0037_dragapult_value_initialized_rl")
    ...
    def test_formal_run_uses_0037_value_seeded_turn_settings(self) -> None:
        ...
        self.assertEqual(config.version, "V3_lora_r8_eval5_50u")
