...
DATASET = ROOT / "rl_runs/0038_action_boundary_rl/datasets/allocation_zero_shot_v1/allocation_samples.pt"
MANIFEST = DATASET.with_name("manifest.json")
OUTPUT = ROOT / "experiments/0038_action_boundary_rl/ALLOCATION_BC_DATA_REPORT.json"
