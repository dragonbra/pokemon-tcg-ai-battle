...
CONTRACTS = importlib.import_module(
    "train.0028_universal_semantic_foundation_pretraining.contracts"
)
...
_valid_mapping = importlib.import_module(
    "train.0028_universal_semantic_foundation_pretraining.tests.test_contracts"
)._valid_mapping
...
class ModelTests(unittest.TestCase):
    ...
    def test_typed_energy_identity_reaches_policy_logits(self) -> None:
        ...
        lightning["option_cat"][..., 8] = 1
        grass["option_cat"][..., 8] = 2
        with torch.inference_mode():
    ...
    def test_shared_prototype_policy_matches_direct_recomputation(self) -> None:
        ...
        self.assertTrue(
            torch.equal(shared_logits.argmax(-1), direct_logits.argmax(-1))
        )
