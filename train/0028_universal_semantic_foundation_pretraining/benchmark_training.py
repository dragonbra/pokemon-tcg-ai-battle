"""Benchmark the formal 0028 train path without allocating a tracked version."""
...
def benchmark(
    *,
    ...
    if not torch.cuda.is_available():
        raise RuntimeError("0028 training benchmark requires CUDA")
    random.seed(seed)
    np.random.seed(seed)
    ...
    return {
        "schema_version": "0028_training_throughput_benchmark_v1",
