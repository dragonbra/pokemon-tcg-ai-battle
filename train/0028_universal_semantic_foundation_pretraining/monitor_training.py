"""Foreground watchdog for a formal 0028 BC training process."""
...
def main() -> None:
    ...
    run_root = (
        Path("rl_runs/0028_universal_semantic_foundation_pretraining/versions")
        / args.version
    )
    ...
    command = [
        sys.executable,
        "-m",
        "train.0028_universal_semantic_foundation_pretraining.run_bc",
        "--version",
        args.version,
        "--dataset-root",
