"""Auditable BC trainer for the 0028 universal semantic policy."""
...
def _train_epoch(
    ...
    *,
    ...
    iterator = tqdm(
        ...
        total=total,
        desc=f"0028 {arm} epoch {epoch} train",
        unit="batch",
        dynamic_ncols=True,
        mininterval=5.0,
        leave=False,
        ...
        with TrainingLogger(paths.metrics, paths.tensorboard) as logger:
            ...
            for epoch in range(1, epochs + 1):
                ...
                _atomic_json(
                    ...
                    {
                        "schema_version": "0028_checkpoint_selection_v1",
                        "retention_slots": [
                            "latest",
                ...
                print(
                    json.dumps({"event": "0028_bc_epoch", **record}, sort_keys=True),
                    flush=True,
                )
