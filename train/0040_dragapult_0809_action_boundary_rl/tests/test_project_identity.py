...
actor_critic = importlib.import_module(
    "train.0040_dragapult_0809_action_boundary_rl.policy.actor_critic"
)
runtime = importlib.import_module(
    "train.0040_dragapult_0809_action_boundary_rl.training.runtime"
)
transfer = importlib.import_module("train.0040_dragapult_0809_action_boundary_rl.transfer")
exporter = importlib.import_module(
    "train.0040_dragapult_0809_action_boundary_rl.export_zero_shot_candidate"
)
full_runner = importlib.import_module(
    "train.0040_dragapult_0809_action_boundary_rl.training.run_full_semantic"
)
league = importlib.import_module("train.0040_dragapult_0809_action_boundary_rl.league")
...
class ProjectIdentityTest(unittest.TestCase):
    ...
    def test_no_executable_cross_project_imports(self) -> None:
        project = Path("train/0040_dragapult_0809_action_boundary_rl")
    ...
    def test_wandb_display_name_keeps_project_prefix(self) -> None:
        self.assertTrue(full_runner.WANDB_DISPLAY_PREFIX.startswith("0040"))
    ...
    def test_formal_run_uses_0040_paired_0809_identity(self) -> None:
        ...
        self.assertEqual(
            config.version, "V2_snapshot_loader_fix_long_run"
        )
