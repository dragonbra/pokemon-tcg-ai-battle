...
FIXTURES = (
    ROOT / "train/0040_dragapult_0809_action_boundary_rl/tests/fixtures/semantic_parity_v1"
)
...
class SemanticParityRegressionFixturesTest(unittest.TestCase):
    def test_fixture_hashes_and_schema_are_immutable(self) -> None:
        module = importlib.import_module(
            "train.0040_dragapult_0809_action_boundary_rl.semantic_parity.freeze_regression_fixtures"
        )
