...
DECK = ROOT / "train/0040_dragapult_0809_action_boundary_rl/league/decks/dragapult_ex_07bedfffbfad/deck.csv"
...
class FullSemanticPolicyTest(unittest.TestCase):
    ...
    def test_exact_policy_0809_inventory_and_trainable_boundary(self) -> None:
