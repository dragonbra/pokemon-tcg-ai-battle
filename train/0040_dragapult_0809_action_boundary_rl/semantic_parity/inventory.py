...
ARCHIVED_U230_INVENTORY_FIXTURE = (
    ROOT
    / "train/0040_dragapult_0809_action_boundary_rl/tests/fixtures/semantic_parity_v1/"
...
def build_runtime_inventory(*, checkpoint: Path, package_root: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "paths": {
            "cuda_rollout_engine_entry": "train/0040_dragapult_0809_action_boundary_rl/rollout/cuda_collector.py:CudaFullSemanticRolloutCollector.collect",
            "cuda_agent_entry": "engine_cuda/python/ptcg_cuda_engine/semantic0031_resident.py:run_resident_greedy_jobs",
            "cuda_model_entry": "train/0040_dragapult_0809_action_boundary_rl/training/run_full_semantic.py:build_collector",
            "frozen_schedule_entry": "train/0040_dragapult_0809_action_boundary_rl/evaluation/frozen_jobs.py:build_frozen_jobs",
            "package_build_entry": "train/0040_dragapult_0809_action_boundary_rl/export_full_semantic_candidate.py:export_candidate",
            "package_agent_entry": "main.py:agent",
            "decision_gate": "train/0040_dragapult_0809_action_boundary_rl/action_boundary/decision_gate.py:DecisionGate",
            "cuda_action_boundary": "train/0040_dragapult_0809_action_boundary_rl/rollout/cuda_action_boundary.py:CudaActionBoundaryAdapter",
            "package_action_boundary": "strategy/deployment/compound_inference.py:PortableCompoundSemanticPolicy",
            "macro_planner": "train/0040_dragapult_0809_action_boundary_rl/action_boundary/macro_planner.py:MacroPlanner",
            "official_pending_transaction": "train/0040_dragapult_0809_action_boundary_rl/action_boundary/macro_protocol.py:PendingMacroTransaction",
            "official_observe_only": "train/0040_dragapult_0809_action_boundary_rl/rollout/worker_compiler.py:WorkerLocalCompiler.observe_only",
        },
        "checkpoint": {
