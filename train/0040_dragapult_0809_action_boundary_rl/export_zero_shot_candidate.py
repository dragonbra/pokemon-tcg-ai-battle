"""Export the audited 0809 checkpoint as a self-contained candidate."""
...
SOURCE_SHA256 = "926321955b6f3144b62e65899b5041ca3a47b17f305202ba9dffc0c92aaa7c7f"
...
def export_candidate(
    *, checkpoint: Path, deck_path: Path, cg_source: Path, output: Path
    ...
    if (
        ...
        or metadata.get("version") != "V5_medal_zone_gsb_all_days"
        or metadata.get("epoch") != 20
        or metadata.get("global_step") != 115820
    ):
        raise ValueError("source checkpoint does not match the audited 0809 contract")
