...
ARTIFACT = ROOT / "rl_runs/0040_dragapult_0809_action_boundary_rl/versions" / VERSION / "artifact"
REPORT = ROOT / "experiments/0040_dragapult_0809_action_boundary_rl/evaluation" / f"{VERSION}.html"
...
def summarize(episodes: list[Any], manifest: dict[str, Any]) -> tuple[dict[str, Any], list[dict[str, Any]]]:
    ...
    taxonomy = json.loads((ROOT / "experiments/0040_dragapult_0809_action_boundary_rl/opponent_meta_taxonomy_v1.json").read_text())
