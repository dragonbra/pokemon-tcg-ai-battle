...
class SourceConditionedR15Policy(R15DeterministicGradualOptionPolicy):
    """Add an auditable expert-persona residual to the shared R15 backbone."""
    ...
    def encode_backbone(self, batch: dict[str, Tensor]) -> tuple[Tensor, Tensor]:
        return super().encode(batch)

    def condition_encoding(
        self,
    ...
    def encode(self, batch: dict[str, Tensor]) -> tuple[Tensor, Tensor]:
        ...
        return self.condition_encoding(self.encode_backbone(batch), source_id)
