"""Build and validate immutable 0016 full-feature shards."""
...
def _compact_records(records: list[Mapping[str, Any]]) -> dict[str, Tensor]:
    ...
    tensors: dict[str, Tensor] = {
        ...
        "source_id": torch.tensor(
            [record["source_id"] for record in records], dtype=torch.int16
        ),
    ...
    *,
    ...
    try:
        ...
        reference: dict[str, Any] = {
            ...
            "raw_record_schema_version": "0016_causal_decision_v1",
