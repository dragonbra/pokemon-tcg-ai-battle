"""Preflight, allocate, resume and train the 0016 R2 strong-scenario policy."""
...
from .source_model import SourceConditionedR2Policy, SourceModelConfig
...
def main() -> None:
    ...
    parser.add_argument("--version", default="V1_win_multideck_r2_scalegate")
    ...
    parser.add_argument("--smoke-tag", default="V0_r2_noncanonical_smoke")
    parser.add_argument("--resume-checkpoint", type=Path)
    arguments = parser.parse_args()
    if not torch.cuda.is_available():
        raise RuntimeError("0016 source-conditioned R2 requires CUDA")
        ...
        os.environ.update(
            {
                ...
                "WANDB_JOB_TYPE": "bc",
                "WANDB_TAGS": "0016,r2,multideck,source_conditioned,scalegate",
            }
        )
        epochs, max_train, max_validation = arguments.epochs, None, None
    ...
    config = {
        "schema_version": "0016_source_r2_training_v1",
    ...
    paths.model_contract.write_text(
        json.dumps(
            {
                "model": "SourceConditionedR2Policy",
                "backbone": "R2StrongScenarioPolicy",
                "parameter_count": sum(
