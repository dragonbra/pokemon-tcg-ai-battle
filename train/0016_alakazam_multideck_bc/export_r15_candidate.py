"""Export an R15 checkpoint as a self-contained arena candidate."""
...
from strategy.source_r15_inference import SourceR15Policy
...
def export_candidate(
    ...
    if metadata.get("schema_version") != "0016_source_r15_training_v1":
        raise ValueError("checkpoint is not an 0016 source-conditioned R15 policy")
    ...
    copies = {
        ...
        "source_r15_model.py": "source_r15_model.py",
        "source_r15_inference.py": "source_r15_inference.py",
    ...
    manifest = {
        "schema_version": "0016_source_r15_candidate_v1",
