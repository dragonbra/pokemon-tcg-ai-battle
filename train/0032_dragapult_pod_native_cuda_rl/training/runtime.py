"""Construct the exact 0032 focal/frozen resident CUDA runtime."""
...
def build_runtime(
    *,
    ...
    focal = read_deck(frozen_root / FOCAL_DECK_ID / "deck.csv")
    pairs = [
        [focal, read_deck(frozen_root / deck_id / "deck.csv")]
...
__all__ = ["FOCAL_DECK_ID", "RuntimeBundle", "build_runtime", "read_deck"]
