"""Audited, explicit 0031-to-0032 initialization transfer."""
...
SOURCE_CHECKPOINT_SHA256 = "05f98e2a562f0037713ebd4b96a5a324151c91b187d7edaa879cc1c024134a51"
...
def transfer_state_dict(
    ...
    *,
    ...
    return {
        "schema": "0032_weight_transfer_audit_v1",
...
def load_0031_initialization(
    ...
    *,
    ...
    report["source_metadata"] = payload.get("metadata", {})
    return report
