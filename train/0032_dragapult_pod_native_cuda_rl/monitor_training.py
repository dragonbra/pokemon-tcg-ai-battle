"""Foreground process watchdog for the formal 0032 CUDA PPO runner."""
...
FATAL_PATTERNS = (
    ...
    "CUDA out of memory",
    "official CUDA rollout failed",
    "behavior log-prob mismatch",
    "FloatingPointError",
)
    ...
    with log_path.open("ab", buffering=0) as log:
        ...
        while True:
            ...
            if returncode is not None:
                if returncode == 0 and str(status.get("state", "")).startswith("completed"):
