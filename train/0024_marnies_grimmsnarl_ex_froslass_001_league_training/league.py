...
def initialize_league_version(
    ...
    *,
    ...
    initial_checkpoint_expectations: Mapping[str, tuple[str, str]] | None = None,
) -> VersionPaths:
    ...
    if initial_checkpoint_expectations is not None:
        if initial_checkpoints is None or set(initial_checkpoint_expectations) != set(initial_checkpoints):
            raise ValueError("checkpoint expectations must cover the initial checkpoint map")
    ...
    try:
        ...
        for plugin in plugins:
            ...
            if source_checkpoint is not None:
                source_deck_id, source_deck_sha256 = (
                    initial_checkpoint_expectations[plugin.deck_id]
                    if initial_checkpoint_expectations is not None
                    else (plugin.deck_id, plugin.deck_sha256)
                )
                load_decoder_checkpoint(
                    source_checkpoint,
        ...
        config = {
            "schema_version": "0024_league_initialization_v1",
