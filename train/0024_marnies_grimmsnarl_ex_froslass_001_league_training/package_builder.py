"""Export audited 0024 decoder checkpoints as self-contained Arena candidates."""
...
''', encoding="utf-8")
    ...
    (target / "strategy/inference.py").write_text(
        '"""Shared-evaluation inference contract for exported 0024 policies."""\n'
...
def build(checkpoint: Path, target_name: str, *, overwrite: bool = False) -> Path:
    ...
    payload = {
        "schema_version": "0024_arena_actor_model_only_v1",
    ...
    manifest = {
        "schema_version": "0024_arena_candidate_v1",
