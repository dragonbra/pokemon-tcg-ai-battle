...
- `mega_lopunny_ex_mega_froslass_ex_002`: the user-provided Mega Lopunny ex / Mega Froslass ex focal list for project 0024.
...
Refresh in place with `python3 train/0024_marnies_grimmsnarl_ex_froslass_001_league_training/deck/build_catalog.py --report docs/environment-daily_kaggle_top100/daily/2026-07-30.html --output train/0024_marnies_grimmsnarl_ex_froslass_001_league_training/deck --refresh`.
...
```json
{
  "schema_version": "0024_league_deck_plugin_v1",
