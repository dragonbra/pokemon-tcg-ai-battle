...
bc = importlib.import_module("train.0033_dragapult_third_ptcg_club_rl.training.bc_smoke")
model_module = importlib.import_module("train.0033_dragapult_third_ptcg_club_rl.model")
fixtures = importlib.import_module("train.0033_dragapult_third_ptcg_club_rl.tests.test_contract")
