"""Fail-closed parity between the evaluated PT0805 package and V3 runtime."""
...
def assert_pt0805_runtime_parity(
    *,
    ...
    if set(local_state) != set(package_state) or any(
        ...
        raise RuntimeError("update-0 PT0805 actor tensors are not bitwise identical")
    compared_tensors = 0
    compared_values = 0
    ...
    report = {
        "schema": "0033_pt0805_full_semantic_runtime_parity_v1",
        "passed": True,
