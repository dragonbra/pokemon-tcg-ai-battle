...
PROJECT_ID = "0033_dragapult_third_ptcg_club_rl"
...
RL_SCHEMA = "0033_full_semantic_decoder_value_model_only_v1"
...
def export_candidate(*, source: Path, checkpoint: Path, output: Path) -> dict[str, Any]:
    ...
    if source_payload.get("schema_version") != SOURCE_SCHEMA:
        raise ValueError("source candidate is not the audited fp16 PT0805 package")
    ...
    try:
        ...
        manifest = {
            "schema_version": "0033_full_semantic_rl_candidate_v1",
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=ROOT
        / "evaluation/arena/candidates/0033_dragapult_third_ptcg_club_zero_shot",
    )
