"""Construct the exact 0033 focal/frozen resident CUDA runtime."""
...
FOCAL_DECK_PATH = (
    ROOT / "train" / "0033_dragapult_third_ptcg_club_rl" / "league" / "decks"
...
def build_runtime(
    *,
    ...
    if deck_multiset_sha256(focal) != FOCAL_DECK_MULTISET_SHA256:
        raise ValueError("0033 focal deck identity mismatch")
