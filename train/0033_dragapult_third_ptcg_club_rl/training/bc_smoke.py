...
project = importlib.import_module("train.0033_dragapult_third_ptcg_club_rl")
model_module = importlib.import_module("train.0033_dragapult_third_ptcg_club_rl.model")
transfer_module = importlib.import_module("train.0033_dragapult_third_ptcg_club_rl.transfer")
