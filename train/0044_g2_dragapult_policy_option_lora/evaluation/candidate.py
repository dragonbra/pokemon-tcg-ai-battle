"""0044 Kaggle-equivalent FP16-storage/FP32-runtime candidate materialization."""
...
class CandidateAudit:
    ...
    status: str = "PASS"
    schema_version: str = "0044_candidate_deployment_identity_audit_v1"
...
def materialize(
    *, checkpoint: Path, base_portable: Path, deck: Sequence[int], deck_id: str,
    ...
    if source.get("schema_version") != "0044_focal_v1_model_only_v1":
        raise RuntimeError("unsupported 0044 model-only checkpoint")
