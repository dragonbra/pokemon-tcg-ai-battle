...
REPORT = REPOSITORY / "experiments/0044_g2_dragapult_policy_option_lora/deck_taxonomy"
DECK_ASSETS = PROJECT / "assets/decks"
assets = importlib.import_module("train.0044_g2_dragapult_policy_option_lora.assets")
generator = importlib.import_module(
    "train.0044_g2_dragapult_policy_option_lora.generate_deck_taxonomy_catalog"
)
...
def test_catalog_has_69_complete_chinese_text_profiles_and_html_details():
    ...
    for index, row in enumerate(manifest["text_profiles"], start=1):
        ...
        assert f"0044 DECK {deck_id}" in text
