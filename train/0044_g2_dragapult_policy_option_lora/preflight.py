...
CONFIG = REPOSITORY_ROOT / "experiments/0044_g2_dragapult_policy_option_lora/active_training_config.json"
...
def run_preflight(*, gpu_smoke: bool = False) -> dict[str, Any]:
    ...
    bundles = [
        materialize_policy_bundle(PROJECT_ROOT, policy_id, purpose="0044_preflight")
    ...
    schedule = build_schedule(
        update=0, seed=430044001, deck_ids=deck_ids, policy_ids=policy_ids,
    ...
    return {
        "schema_version": "0044_pretraining_preflight_v1",
        "status": "PASS",
