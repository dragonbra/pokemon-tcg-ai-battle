...
V2 is running at W&B run `0037-v2-engine-pool-prototype-cache-seeded512`. Its fixed checkpoint-0 suite reproduced V1's exact 287–225 result and 93,268 selections, while wall fell from `417.389` to `195.457 s`. Formal update 1 completed 512/512 with zero errors in `229.872 s` rollout plus `136.448 s` PPO. Behavior replay MAE was `1.383e-5`, explained variance `0.4075`, Value loss `0.3598`, Encoder hash unchanged, and checkpoint 1 was saved. The rollout recorded 1,179 focal and 1,156 opponent prototype-cache hits with zero build/invalidation inside collection. Later versions may test partial Encoder unfreezing/LoRA or Value-guided action search; neither is part of V2.
