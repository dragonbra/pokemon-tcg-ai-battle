# Alakazam V8 Luna Deck Opt New Eval Implementation Plan
...
**Files:**
- Create: `work/auto-iteration/history_iterations/alakazam_v8_luna_deck_opt_new_eval/baseline-2026-07-21.md`
- Create: `work/auto-iteration/history_iterations/alakazam_v8_luna_deck_opt_new_eval/baseline/`（evaluation 输出）
...
python3 -m evaluation run \
  ...
  --no-visualize \
  --output work/auto-iteration/history_iterations/alakazam_v8_luna_deck_opt_new_eval/baseline
```
...
- Modify: `work/auto-iteration/history_iterations/alakazam_v8_luna_deck_opt_new_eval/PLAN.md`
...
**Files:**
- Create: `work/auto-iteration/history_iterations/alakazam_v8_luna_deck_opt_new_eval/iteration-001/`
- Create: `work/auto-iteration/history_iterations/alakazam_v8_luna_deck_opt_new_eval/iteration-002/`（如需要）
- Create: `work/auto-iteration/history_iterations/alakazam_v8_luna_deck_opt_new_eval/iteration-*.md`
...
python3 -m evaluation run \
  ...
  --metric-profile auto_iteration_v8_setup_relay \
  --no-visualize \
  --output work/auto-iteration/history_iterations/alakazam_v8_luna_deck_opt_new_eval/iteration-001
```
...
**Files:**
- Modify: `work/auto-iteration/history_iterations/alakazam_v8_luna_deck_opt_new_eval/FINAL.md`
