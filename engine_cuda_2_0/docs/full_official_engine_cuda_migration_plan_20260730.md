...
- extractor、通用 VM、测试框架可以版本化；生成的完整 rule pack 放在
  `engine_cuda_2_0/generated/private/<oracle-id>/` 并强制 Git ignore。
...
现有 `engine_cuda_2_0/` 是正确的垂直切片，可以复用：
...
python engine_cuda_2_0/tools/extract_official_rules.py \
  ...
  --out engine_cuda_2_0/generated/private/<oracle-id>
python engine_cuda_2_0/tools/verify_rule_pack.py --manifest <manifest>

# CPU official -> CPU POD
python engine_cuda_2_0/tools/run_paired_replay.py \
...
python engine_cuda_2_0/tools/check_card_branch_coverage.py --require-complete
python engine_cuda_2_0/tools/run_promoted_deck_matrix.py \
  --seeds 1024 --both-seats --strict --output <private-report>

# codec
python engine_cuda_2_0/tools/replay_device_codec.py \
  --codec policy_codec_v1 --corpus <127205-corpus> --strict
python engine_cuda_2_0/tools/replay_all_legacy_codecs.py --strict

# PPO fresh/resume
python engine_cuda_2_0/tools/run_full_cuda_ppo_smoke.py --fresh <run-dir>
python engine_cuda_2_0/tools/run_full_cuda_ppo_smoke.py --resume <run-dir>
python engine_cuda_2_0/tools/verify_full_cuda_ppo_smoke.py <run-dir>
```
...
python engine_cuda_2_0/tools/analyze_nsys_hot_range.py <report>
```
