...
RUN_DIR="${PPO_SMOKE_RUN_DIR:-$ROOT/engine_cuda_2_0/artifacts/ppo_smoke_6bc_decoder_only/run}"
MODE="${1:-fresh}"
...
exec "$PYTHON_BIN" tools/train_pure_lucario_ppo.py \
  --config "$ROOT/engine_cuda_2_0/configs/pure_lucario_bc_pool_ppo_smoke.json" \
