...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--torch-build-rel", default="engine_cuda_2_0/build/torch_official")
...
def run_setup_parity(
    ...
    *,
    ...
    py_path = f"/workspace/{torch_build}:/workspace/engine_cuda_2_0/python:/workspace/engine_cuda_2_0/tools"
    cuda_command = [
        "docker",
        "run",
        "--rm",
