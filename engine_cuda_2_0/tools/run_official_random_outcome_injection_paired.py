...
def main() -> int:
    ...
    container_command = (
        ...
        "-I/official -I/workspace/engine_cuda_2_0/include -I/workspace/engine_cuda_2_0/extractor "
        "-I/workspace/engine_cuda_2_0/benchmarks "
        "/workspace/engine_cuda_2_0/benchmarks/official_random_outcome_injection_paired.cu "
