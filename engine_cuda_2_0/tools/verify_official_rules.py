...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Verify a private official-engine IR extraction and its provenance."
    )
...
def main() -> None:
    args = parse_args()
    result = verify_extraction_manifest(
        args.directory,
        ...
        json.dumps(
            {
                ...
                "payload_sha256": result["manifest"]["payload_sha256"],
