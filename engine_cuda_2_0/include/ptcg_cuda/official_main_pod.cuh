...
PTCG_OFFICIAL_MAIN_HD inline OfficialMainResult official_apply_main_action(
    ...
    if (type == OfficialSelectOptionTypeId::kPlay) {
        ...
        if (card_type == 0
            ...
            const std::int32_t enemy_second_effect_start =
                play_skill->values[kSkillSecondEffectStartEnemy];
            const bool has_effect_choice = second_effect_start > 0
                || enemy_second_effect_start > 0;
            ...
            if (has_effect_choice && first_effect_satisfied) {
                ...
                if (!official_begin_effect_selection(
                        ...
                        enemy_second_effect_start > 0 ? 1 - player : player,
                        1,
                        1,
                        enemy_second_effect_start > 0
                            ? OfficialEffectResumeKind::kEnemySkillChooseEffect
