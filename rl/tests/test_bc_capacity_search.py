...
from rl.train.bc_capacity_search import (
    ARCHITECTURES,
    TrialSpec,
    _can_launch,
    _run_trial,
...
from rl.train.render_bc_capacity_search import _update_index
...
class BCCapacitySearchTests(unittest.TestCase):
    ...
    def test_training_log_staging_keeps_new_version_unoccupied(self) -> None:
        with TemporaryDirectory() as directory:
            ...
            experiment_root = repository_root / "rl/_runs/0004-test"
            ...
            with patch(
                "rl.train.bc_capacity_search._run_logged_process",
