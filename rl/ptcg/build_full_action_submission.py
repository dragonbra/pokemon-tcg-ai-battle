...
def build(
    ...
    *,
    ...
    shutil.copy2(repository_root / "rl" / "ptcg" / "features.py", strategy / "features.py")
    shutil.copy2(repository_root / "rl" / "core" / "model.py", strategy / "core_model.py")
    full_action_model = (repository_root / "rl" / "ptcg" / "full_action_model.py").read_text(
        encoding="utf-8"
    ).replace(
    ...
    inference = (repository_root / "rl" / "ptcg" / "full_action_inference.py").read_text(
        encoding="utf-8"
    ).replace(
