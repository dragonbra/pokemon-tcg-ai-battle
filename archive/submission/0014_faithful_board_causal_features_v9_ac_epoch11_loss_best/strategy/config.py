...
# Immutable provenance only.  Raw 0013 shards were intentionally retired and
# must never be imported or rebuilt as a runtime dependency of 0014.
RAW_DATASET_PROVENANCE = (
