...
try:
    ...
    from train.0010_alakazam_sota_model.model import collate_id_only
...
class FeatureEngineeringInference:
    ...
    def select(self, observation: dict[str, Any]) -> list[int]:
        ...
        # Dataset training intentionally drops labels beyond max_action_steps, but the
        # live simulator can require longer mandatory selections (for example Xerosic
        # discards from a large hand).  Inference must preserve the live legality
