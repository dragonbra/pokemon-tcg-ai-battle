...
- 实际读取 trace 文件：170
- 对局：170；胜 / 负 / 平：105 / 63 / 2
- 我方错误：0
- 胜率：61.8%
- Meta 加权胜率：62.7%
- 第二回合 Powerful Hand：36/170 (21.2%)
- 我方被击倒事件：191
- 击倒后无 ready attacker：133/191 (69.6%)
...
| failure_class | 数量 |
|---|---:|
| bench_insurance_missed | 244 |
| post_ko_no_ready_attacker | 133 |
...
```json
{
  ...
  "command": [
    ...
    "--label",
    "alakazam_v7_auto_iter_iter21_patch_gate",
    "--opponents",
    ...
    "--save-traces",
    "--output",
    "/private/tmp/alakazam-v7-auto-iter-21-full",
    "--cg-path",
  ...
  "games": 10,
  "label": "alakazam_v7_auto_iter_iter21_patch_gate",
  "opponents": [
    "romanrozen_v9",
    "pilkwang_v2",
    "kokinn_search",
