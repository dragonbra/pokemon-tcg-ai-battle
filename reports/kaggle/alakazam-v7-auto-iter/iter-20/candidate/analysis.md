...
- 实际读取 trace 文件：170
- 对局：170；胜 / 负 / 平：103 / 64 / 3
- 我方错误：0
- 胜率：60.6%
- Meta 加权胜率：60.2%
- 第二回合 Powerful Hand：48/170 (28.2%)
- 我方被击倒事件：184
- 击倒后无 ready attacker：127/184 (69.0%)
...
| failure_class | 数量 |
|---|---:|
| bench_insurance_missed | 255 |
| post_ko_no_ready_attacker | 127 |
...
```json
{
  ...
  "command": [
    ...
    "--label",
    "alakazam_v7_auto_iter_iter20_patch_abra",
    "--opponents",
    ...
    "--save-traces",
    "--output",
    "/private/tmp/alakazam-v7-auto-iter-20-full.JBY27s",
    "--cg-path",
  ...
  "games": 10,
  "label": "alakazam_v7_auto_iter_iter20_patch_abra",
  "opponents": [
    "romanrozen_v9",
    "pilkwang_v2",
    "kokinn_search",
