...
- 实际读取 trace 文件：170
- 对局：170；胜 / 负 / 平：103 / 65 / 2
- 我方错误：0
- 胜率：60.6%
- Meta 加权胜率：59.6%
- 第二回合 Powerful Hand：40/170 (23.5%)
- 我方被击倒事件：161
- 击倒后无 ready attacker：110/161 (68.3%)
...
```json
{
  ...
  "command": [
    ...
    "--label",
    "alakazam_v7_auto_iter_iter23_lana_successor_recovery",
    "--opponents",
    ...
    "--save-traces",
    "--output",
    "/private/tmp/alakazam-v7-auto-iter-23-full",
    "--cg-path",
  ...
  "games": 10,
  "label": "alakazam_v7_auto_iter_iter23_lana_successor_recovery",
  "opponents": [
    "romanrozen_v9",
    "pilkwang_v2",
    "kokinn_search",
