...
- 胜率：61.2%
- Meta 加权胜率：62.5%
- 第二回合 Powerful Hand：43/170 (25.3%)
- 我方被击倒事件：170
- 击倒后无 ready attacker：104/170 (61.2%)
...
| failure_class | 数量 |
|---|---:|
| bench_insurance_missed | 252 |
| post_ko_no_ready_attacker | 104 |
| second_turn_powerful_hand_missing | 127 |
...
```json
{
  ...
  "command": [
    ...
    "--save-traces",
    "--output",
    "/private/tmp/alakazam-v7-auto-iter/iter-06-full",
    "--cg-path",
