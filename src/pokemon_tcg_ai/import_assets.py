"""One-time import of approved assets into the self-contained 0044 project.
...
EXPERIMENT_ROOT = REPOSITORY_ROOT / "experiments/0044_g2_dragapult_policy_option_lora"
...
def import_decks() -> tuple[list[dict[str, Any]], list[dict[str, Any]]]:
    ...
    _write_json(
        ...
        {
            "schema_version": "0044_deck_registry_v2_numeric_identity",
...
def import_policies() -> list[dict[str, Any]]:
    ...
    _write_json(
        ...
        {
            "schema_version": "0044_policy_registry_v1",
...
def import_evaluation(entries: list[dict[str, Any]]) -> None:
    manifest = {
        "schema_version": "0044_frozen_evaluation_manifest_v2_numeric_deck_identity",
    ...
    seeds = {
        "schema_version": "0044_frozen_seed_contract_v1",
        "evaluation_id": "FrozenMeta256-V1",
    ...
    _write_json(
        ...
        {
            "schema_version": "0044_evaluation_registry_v1",
            "evaluations": [
                {
...
def import_semantic_runtime() -> None:
    """Freeze the approved inference source inside 0044 without a runtime dependency.

    The archived package is provenance only. Every executable import after this
    one-time operation resolves below ``0044_g2_dragapult_policy_option_lora.semantic_runtime``.
    ...
    _write_json(
        ...
        {
            "schema_version": "0044_semantic_runtime_manifest_v1",
