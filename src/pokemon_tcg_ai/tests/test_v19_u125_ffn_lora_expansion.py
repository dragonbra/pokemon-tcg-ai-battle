...
V17_PARENT = (
    ROOT / "runs/versions/V17_policy0814_v16_u112_complete_delta_restart/"
    "checkpoint/update-000125.pt"
)
requires_private_v17 = pytest.mark.skipif(
    not V17_PARENT.is_file(),
    reason="requires private V17 U125 checkpoint from runs/",
)
